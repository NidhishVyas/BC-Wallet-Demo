...
export const PickCharacter: React.FC<Props> = ({ currentCharacter, characters, title, text, textWithImage }) => {
  ...
  const defaultText = `It’s time to pick your character. Every character has its own set of use cases, which explore the power of vehicle credentials. Don’t worry, you can change your character later.`
