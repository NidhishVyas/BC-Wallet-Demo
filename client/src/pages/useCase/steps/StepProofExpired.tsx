...
import { ExpiredCTA } from '../../../components/ExpiredCTA'
...
import { ProofAttributesCardExpired } from '../components/ProofAttributesCardExpired'
...
export const StepProofExpired: React.FC<Props> = ({
  proof,
  step,
  connectionId,
